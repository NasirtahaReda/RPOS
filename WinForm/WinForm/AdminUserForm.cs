...
////            }
        ...
        private void btnShiftClose_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                if (MessageBox.Show("خروج من النظام؟", "نظام رضا بوكشوب", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == System.Windows.Forms.DialogResult.Yes)
        ...
        private void btnNewExpense_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ExpensesForm frm = new ExpensesForm();
        ...
        {
            AddControl(new GategoryUC(), "أنواع الأصناف");
        }
        ...
        {
            AddControl(new PurchaseInvoiceUC(), "فواتير المشتروات");
        }

        private void btnNewPurchaseInvoice_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
        ...
        private void btnNewDamege_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
        ...
        private void btnDamege_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            AddControl(new DamegeUC(db), "فواتير التالف");
        }
        ...
        {
            AddControl(new InteractiveDashboard(), "لوحة التقارير");
        }

        private void btnPushover_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            AddControl(new PushOverUC(), " Push Over");
        }
        ...
        private void btnQuickCode_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            QuickItem qi = new QuickItem();
            AddControl(qi, " الأرقام السريعة");
        }
        ...
        private void btnUserPaymentReport_Click(object sender, EventArgs e)
        {
            ...
            {
                int userID = Convert.ToInt32(UserData.Default.UserID);
                UserPaymentReportOptions frm = new UserPaymentReportOptions(true, userID);
                frm.ShowDialog();
            }
            catch (Exception ex)
            {
        ...
        private void btnAddMoney_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
